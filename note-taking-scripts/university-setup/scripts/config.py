...
CURRENT_COURSE_SYMLINK = Path('/home/mikko/Documents/note-taking-scripts/wildmath/current_course').expanduser()
CURRENT_COURSE_ROOT = CURRENT_COURSE_SYMLINK.resolve()
CURRENT_COURSE_WATCH_FILE = Path('/tmp/current_course').resolve()
ROOT = Path('/home/mikko/Documents/note-taking-scripts/wildmath').expanduser()
